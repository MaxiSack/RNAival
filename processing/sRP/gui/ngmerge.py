...
def add_sRP_ngmerge_GUI(main,parent):
	...
	addThemedEntry(main,ngmergeSettingsFrame,width=main.numberEntryWidth,textvariable=main.PM.add("sRP-merge-minPairedOverlap","int",10,
	...
	produceShortestReadsVar = main.PM.add("sRP-merge-produceShortestRead","bool",True,"Bool","Produce the shortest read when merging (yes/no).",tag="sRP-ngmerge")
	...
	addThemedEntry(main,ngmergeSettingsFrame,textvariable=main.PM.add("sRP-merge-extraParams","text","",
